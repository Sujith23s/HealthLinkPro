...
function Signup() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post("http://localhost:5001/register", Form)
      .then(result => {
        console.log(result);
        navigate("/Login");
      })
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-blue-200 to-blue-400 ">
      <div className="bg-white p-6 rounded w-1/2">
        ...
        <p className="mt-4 font-semibold text-center text-gray-600">Already have an Account?<Link to="/Login" className="ml-4 font-semibold text-blue-800">Login</Link></p>
      </div>
    </div>
  );
}
